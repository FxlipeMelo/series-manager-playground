 ...
 */
final class Version20251013223940 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Criando as tabelas depois de mudar SQLite para MySQL';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE episode (id INT AUTO_INCREMENT NOT NULL, season_id INT NOT NULL, watched TINYINT(1) NOT NULL, number SMALLINT NOT NULL, INDEX IDX_DDAA1CDA4EC001D1 (season_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
